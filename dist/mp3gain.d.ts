...
declare namespace mp3gain {
    const ON_STDERROR: string;
    const ON_STDOUT: string;
    const mp3Path: string;
    class MP3GainWrapper extends emloader.event.EventEmiter {
        protected binpath: string;
        private files;
        constructor(binpath: string);
        addFile(fileOrUrl: emloader.IFile | string): Promise<emloader.IFile>;
        addFiles(filesOrUrls: Array<emloader.IFile | string>): Promise<emloader.IFile[]>;
        removeFile(file: emloader.IFile): boolean;
        removeFiles(): Array<emloader.IFile>;
        getFiles(): Array<emloader.IFile>;
...
declare namespace mp3gain {
    class MP3Gain extends MP3GainWrapper {
        constructor();
        runAsWorker(args: Array<string> | string): Promise<emloader.IFile[]>;
        runWithEmloader(args: Array<string> | string): Promise<emloader.IFile[]>;
    }
    function getInstance(): MP3Gain;
}
